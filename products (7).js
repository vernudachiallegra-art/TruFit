...
// Session 8: lets netlify/functions/chat.js reuse this exact same file on the server,
// instead of a second copy of the catalogue that could drift out of sync. Browsers
// ignore this block completely (there's no "module" object in a browser), so nothing
// about how the website itself works is affected.
if (typeof module !== "undefined") {
  module.exports = { CATEGORIES, SHOE_CATEGORIES, ALL_SHOE_CATEGORIES, STYLE_WORDS, PRODUCTS };
}
